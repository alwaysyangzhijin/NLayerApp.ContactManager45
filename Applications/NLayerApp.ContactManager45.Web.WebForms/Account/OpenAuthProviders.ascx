<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="NLayerApp.ContactManager45.Web.WebForms.Account.OpenAuthProviders" %>
